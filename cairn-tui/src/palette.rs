...
pub fn all_palette_commands() -> Vec<PaletteCommand> {
    vec![
        ...
        PaletteCommand {
            name: "Set tier: Atlas",
            description: "Authoritative codebase knowledge (full blocks in prime)",
            key_hint: None,
            action: Action::SetTierAtlas,
            edit_only: true,
            browse_only: false,
        },
        PaletteCommand {
            name: "Set tier: Journal",
            description: "Task records, decisions, outcomes (summary-only in prime)",
            key_hint: None,
            action: Action::SetTierJournal,
            edit_only: true,
            browse_only: false,
        },
        PaletteCommand {
            name: "Set tier: Notes",
            description: "Scratch, hypotheses (excluded from prime)",
            key_hint: None,
            action: Action::SetTierNotes,
            edit_only: true,
            browse_only: false,
        },
        PaletteCommand {
